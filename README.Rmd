...
#ssp_sumarizada_projecao %>% filter (!is.na(regiao)) %>% pull(regiao) %>% #unique() %>% gridExtra::tableGrob(cols = "Regiões")
...
```{r graficos_covid_sp, echo=FALSE, message=FALSE, warning=FALSE}
