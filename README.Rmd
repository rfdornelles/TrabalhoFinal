...
grafico_animado1 <- ssp_sumarizada_projecao %>%
...
gganimate::animate(grafico_animado1, end_pause = 40)
...
```{r mapa_diferenças_CVLI, echo=FALSE, message=FALSE, warning=FALSE}
...
# tabela mostrando cidades com mais mortes por COVID
